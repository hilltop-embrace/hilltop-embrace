			...
			<FluidContainer fluid>
					...
					<Row>
						<Col>
							<StyledParagraph>
								...
								their fight against systemic homelessness in New Brunswick, New
								Jersey.
							</StyledParagraph>
						</Col>
					</Row>
					...
					<Row>
						<Col>
							<StyledParagraph>
								...
								dehumanizing effects of stigmas against the homeless community.
								In an effort to break those ideas, Hilltop Embrace creates an
								environment where individuals can develop intentional
								relationships with the homeless and vulnerable populations to
								provide them assistance for the present and future.
							</StyledParagraph>
						</Col>
					</Row>
				</Container>
				...
				<Container className="mb-container">
					...
					<Row>
						<Col>
							<StyledParagraph>
								...
								COVID-19, we have been collecting donations and purchasing meals
								from local businesses and giving out meals to go.
							</StyledParagraph>
						</Col>
					</Row>
					<Row>
						<Col>
							<StyledParagraph>
								...
								businesses to tackle many aspects of homelessness through social
					...
					<Row>
						<Col>
							<StyledParagraph>
								These actions will reflect our core values of aiding their daily
								lives while helping our community members to invest in
					...
					<Row>
						...
						<Col xs={12} md={6}>
							...
							<StyledParagraph>
								...
								All money collected will be used for the homeless community and
								detailed financial spendings will be updated accordingly via on
								our website.
							</StyledParagraph>
						</Col>
					</Row>
